...
const steps = [
  { icon: ChatCircleDots, text: "Nous recevons votre message" },
  { icon: Handshake, text: "Un membre de notre équipe vous répond personnellement" },
  { icon: CalendarCheck, text: "Nous organisons un rendez-vous si nécessaire" },
];
